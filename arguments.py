...
def get_args():
    ...
    parser.add_argument(
        "--use_self_attn", type=bool, default=True, help="Attention size"
    )

    # use attn between humans and robots or not (todo: implment this in network models)
    parser.add_argument("--use_hr_attn", type=bool, default=True, help="Attention size")
    ...
    parser.add_argument(
        "--env-name", default="CrowdSimPredRealGST-v0", help="name of the environment"
    )
